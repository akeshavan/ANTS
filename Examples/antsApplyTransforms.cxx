  ...
  for( unsigned int n = 0; n < inputImages.size(); n++ )
{
  ...
  if( outputOption && outputOption->GetNumberOfFunctions() )
    ...
    if( outputOption->GetFunction( 0 )->GetNumberOfParameters() > 1 &&
        parser->Convert<unsigned int>( outputOption->GetFunction( 0 )->GetParameter( 1 ) ) != 0 )
      {
      antscout << "Output composite transform displacement field: " << outputOption->GetFunction( 0 )->GetParameter( 0 ) << std::endl;
      ...
      if( inputImageType == 1 )
        ...
        itk::ImageRegionIteratorWithIndex<DisplacementFieldType> It( outputVectorImage, outputVectorImage->GetRequestedRegion() );
        ...
        itk::ImageRegionIteratorWithIndex<TensorImageType> It( outputTensorImage, outputTensorImage->GetRequestedRegion() );
