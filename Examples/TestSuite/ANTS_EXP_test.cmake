...
add_test(${THIS_TEST_NAME} ${TEST_BINARY_DIR}/ANTS 2
 -m PR[${R16_IMAGE},${R64_IMAGE},1,4] -r Gauss[0.5,0.25]
 -t Exp[0.5,2,0.5] -i 50x50x50 -o ${OUTPUT_PREFIX}.nii.gz
 )
...
add_test(${THIS_TEST_NAME}_JPG ${TEST_BINARY_DIR}/ConvertToJpg ${WARP_IMAGE} ANTSEXP.jpg)
