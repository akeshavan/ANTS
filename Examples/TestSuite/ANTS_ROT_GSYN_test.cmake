#####################################################################################
#####################################################################################
set(THIS_TEST_NAME ${THIS_TEST_NAME})
...
add_test(${THIS_TEST_NAME} ${TEST_BINARY_DIR}/ANTS 3
 -m MSQ[${ROT_REF_IMAGE},${ROT_MOV_IMAGE},1,0]
 -t SyN[0.25] -i 50x5x0 -r Gauss[3,0.0,32]
 -o ${OUTPUT_PREFIX}.nii.gz)

add_test(${THIS_TEST_NAME}_WARP ${TEST_BINARY_DIR}/WarpImageMultiTransform 3
...
add_test(${THIS_TEST_NAME}_WARP_METRIC_0
 ${TEST_BINARY_DIR}/MeasureImageSimilarity 3 0
...
add_test(${THIS_TEST_NAME}_INVERSEWARP ${TEST_BINARY_DIR}/WarpImageMultiTransform 3
