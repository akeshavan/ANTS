...
add_test(NAME ${THIS_TEST_NAME} COMMAND $<TARGET_FILE:ANTS> 3
 -m MSQ[${ROT_REF_IMAGE},${ROT_MOV_IMAGE},1,0]
 -t Exp[3,2] -i 50x5x1 -r Gauss[3,0.0,32]
 -o ${OUTPUT_PREFIX}.nii.gz)

add_test(NAME ${THIS_TEST_NAME}_WARP COMMAND $<TARGET_FILE:WarpImageMultiTransform> 3
...
add_test(NAME ${THIS_TEST_NAME}_WARP_METRIC_0 COMMAND $<TARGET_FILE:MeasureImageSimilarity> 3 0
...
add_test(NAME ${THIS_TEST_NAME}_WARP2 COMMAND $<TARGET_FILE:WarpImageMultiTransform> 3
...
add_test(NAME ${THIS_TEST_NAME}_WARP2_METRIC_0_2 COMMAND $<TARGET_FILE:MeasureImageSimilarity> 3 0 ${ROT_REF_IMAGE}
 ${WARP_IMAGE} ${OUTPUT_PREFIX}log.txt
 ${OUTPUT_PREFIX}metric.nii.gz 35.4473 0.5)
set_property(TEST ${THIS_TEST_NAME}_WARP2_METRIC_0_2 APPEND PROPERTY DEPENDS ${THIS_TEST_NAME}_WARP2)

add_test(NAME ${THIS_TEST_NAME}_INVERSEWARP COMMAND $<TARGET_FILE:WarpImageMultiTransform> 3
...
add_test(NAME ${THIS_TEST_NAME}_INVERSEWARP_METRIC_0 COMMAND $<TARGET_FILE:MeasureImageSimilarity> 3 0 ${ROT_MOV_IMAGE}
...
add_test(NAME ${THIS_TEST_NAME}_INVERSEWARP2 COMMAND $<TARGET_FILE:WarpImageMultiTransform> 3
...
add_test(NAME ${THIS_TEST_NAME}_INVERSEWARP2_METRIC_0_2 COMMAND $<TARGET_FILE:MeasureImageSimilarity> 3 0 ${ROT_MOV_IMAGE}
