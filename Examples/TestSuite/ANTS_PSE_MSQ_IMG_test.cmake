...
add_test(${THIS_TEST_NAME}_WARP_METRIC_1
 ${TEST_BINARY_DIR}/MeasureImageSimilarity 2 1
 ${DEVIL_IMAGE} ${WARP_IMAGE}
 ${OUTPUT_PREFIX}log.txt ${OUTPUT_PREFIX}metric.nii.gz
 -0.884041 0.05)
...
set_property(TEST ${THIS_TEST_NAME}_JPGINV APPEND PROPERTY DEPENDS ${THIS_TEST_NAME})
