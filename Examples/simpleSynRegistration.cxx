...
namespace ants
{
  ...
  CompositeTransformType::TransformTypePointer
    simpleSynReg( ImageType::Pointer & fixedImage, ImageType::Pointer & movingImage, const CompositeTransformType::Pointer compositeInitialTransform )
      {
  ...
  int simpleSynRegistration( std::vector<std::string> args, std::ostream* out_stream = NULL )
    ...
    CompositeTransformType::TransformTypePointer outputTransform = simpleSynReg( fixedImage, movingImage, compositeInitialTransform );
    ...
    if (writeInverse)
      ...
      DisplacementFieldTransformType::Pointer dispTransform = dynamic_cast<DisplacementFieldTransformType *>(outputTransform.GetPointer() );
