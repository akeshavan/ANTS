...
//    optimizer->SetMaximumLineSearchIterations( 20 );
    ...
    switch( whichTransform )
      ...
      case Exponential:
        ...
        RealType varianceForUpdateField = this->m_TransformMethods[currentStage].m_UpdateFieldVarianceInVarianceSpace;
        RealType varianceForVelocityField  = this->m_TransformMethods[currentStage].m_VelocityFieldVarianceInVarianceSpace;
...
void
RegistrationHelper<VImageDimension>
::ApplyCompositeLinearTransformToImageHeader( const CompositeTransformType * compositeTransform, ImageBaseType * image, bool applyInverse )
{
